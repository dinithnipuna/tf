      ...
      <div class="ms-menu">
          <div class="ms-user clearfix">
              @if(Auth::user()->avatar != null)
                <img src="{{asset('images/users/'. Auth::user()->avatar)}}" alt="" class="img-avatar pull-left">
              @else
                <img src="{{ asset('images/users/default.png')}}" alt="" class="img-avatar pull-left">
              @endif              
          ...
          <div class="list-group lg-alt">
              @foreach(Auth::user()->pms() as $pm)
              <a class="list-group-item media" href="#">
                  <div class="pull-left">
                      @if($pm->avatar != null)
                        <img src="{{asset('images/users/'. $pm->avatar)}}" alt="" class="img-avatar">
                      @else
                        <img src="{{ asset('images/users/default.png')}}" alt="" class="img-avatar ">
                      @endif   
                  </div>
                  <div class="media-body">
                      <div class="list-group-item-heading">{{ $pm->name }}</div>
                      <small class="list-group-item-text c-gray">{{ $pm->pivot->message }}</small>
                  </div>
              </a>
              @endforeach
              ...
              <a class="list-group-item media" href="#">
                  <div class="pull-left">
                      <img src="img/Friends/guy-3.jpg" alt="" class="img-avatar">
                  </div>
                  <div class="media-body">
              ...
              <a class="list-group-item media" href="#">
                  <div class="pull-left">
                      <img src="img/Friends/guy-4.jpg" alt="" class="img-avatar">
                  </div>
                  <div class="media-body">
              ...
              <a class="list-group-item media" href="#">
                  <div class="lv-avatar pull-left">
                      <img src="img/Friends/guy-5.jpg" alt="" class="img-avatar">
                  </div>
                  <div class="media-body">
              ...
              <a class="list-group-item media" href="#">
                  <div class="lv-avatar pull-left">
                      <img src="img/Friends/guy-6.jpg" alt="" class="img-avatar">
                  </div>
                  <div class="media-body">
              ...
              <a class="list-group-item media" href="#">
                  <div class="pull-left">
                      <img src="img/Friends/guy-7.jpg" alt="" class="img-avatar">
                  </div>
                  <div class="media-body">
              ...
              <a class="list-group-item media" href="#">
                  <div class="lv-avatar pull-left">
                      <img src="img/Friends/guy-2.jpg" alt="" class="img-avatar">
                  </div>
                  <div class="media-body">
