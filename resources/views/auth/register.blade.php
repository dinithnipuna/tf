            ...
            <div class="reg-form-container"> 
              ...
              <div class="tab-content">
                <div class="tab-pane active" id="register">
                  ...
                  <!--Register Form-->
                  <form name="registration_form" id="registration_form" class="form-inline" action="{{ url('/signup') }}" method="POST" role="form">
                  {{ csrf_field() }}
                    <div class="row">
                      <div class="form-group col-xs-12">
                        <label for="name" class="sr-only">Your Name</label>
                        <input id="name" class="form-control input-group-lg" type="text" name="name" title="Enter your name" placeholder="Your name"/>
                      </div>
                    </div>
                    <div class="row">
                      <div class="form-group col-xs-12">
                    ...
                    <div class="row">
                      <div class="form-group col-xs-12">
                        ...
                        <input id="password_confirmation" class="form-control input-group-lg" type="password" name="password_confirmation" title="Enter password" placeholder="Confirm Password"/>
                      </div>
                    </div>
